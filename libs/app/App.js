...
var App = (function () {
    ...
    function Window(config) {
        ...
        if (params.extra_button) {
            var extra_button = document.createElement('div');
            extra_button.className = params.extra_button_class_name;
            window_el.appendChild(extra_button);

            if (typeof params.extra_button_event === 'function') {
                extra_button.addEventListener('click', params.extra_button_event, false);
            }
        }
